...
- CIE Lab conversion and Delta E are implemented with sRGB/D65 color math; KMeans returns a one-dimensional palette image with alpha weights, and palettize/paletteCentroid use color-distance assignment. Spot-color, saliency, segmentation, material, lighting, transition, and advanced distortion filters are still approximations;
